# sendbird-demo
A demo of the profanity filter feature within Sendbird as well as browser notifications upon new messages being received. Instructions below are from the web-basic-sample demo found here: [SendBird JavaScript Web Basic Sample](https://github.com/sendbird/SendBird-JavaScript/tree/master/web-basic-sample)
